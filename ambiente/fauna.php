				  ...
				  { 	
				     $fi=($_POST['filas']-1);
					  ...
					  {   
						...
						$mov= new acciones();
						$ms=$mov->guardar("recursofauna","idespeciefauna,zona,cantidad,idmedioamb,idcomunidad","'$b','$c','$d','$e','$f'");
						}
					   }
					}
...
<div id="menu">
		...
		<section>
			...
			<td><input type=image src='../libreria/images/printer.png' id="nuevo2" name="nuevo2" value="imprimir" title="Imprimir" onclick="location.href='../impresion/inicio.php';"></td>
		...
		<fieldset>
			...
			<section>
						...
						<form action="fauna.php" method="get">
						<table>
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("recursofauna","idespeciefauna","idrecursofauna='$ii'");
			}
			//Guardar
			?>
			</td></tr>
			...
			echo $con->consultar("recursofauna,comunidad,especiefauna,medioamb","idrecursofauna as 'ID',especiefauna.nombre as 'Fauna',zona as 'Zona Geograf&iacute;ca',cantidad as 'Cantidad Existente',medioamb.ambiente as 'Medio Ambiente',comunidad.nombre as 'Comunidad'","comunidad.idcomunidad=recursofauna.idcomunidad and medioamb.idmedioamb=recursofauna.idmedioamb and especiefauna.idespeciefauna=recursofauna.idespeciefauna order by recursofauna.idrecursofauna desc limit 5");
			?>
						</fieldset>
					</div>
				</section>			
