...
if (isset($_GET['id']))
	{
		...
		$id=$_GET['id'];
		$b=new consultas();
		$mod1=$b->buscarvalor("recursofauna","idespeciefauna","idrecursofauna='$id'");
		$mod2=$b->buscarvalor("recursofauna","zona","idrecursofauna='$id'");
		$mod3=$b->buscarvalor("recursofauna","cantidad","idrecursofauna='$id'");
		$mod4=$b->buscarvalor("recursofauna","idmedioamb","idrecursofauna='$id'");
		$mod5=$b->buscarvalor("recursofauna","idcomunidad","idrecursofauna='$id'");
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="modificarfa.php" >
			<fieldset>
                <legend>
                Datos de la Fauna
                </legend>
				...
				<tr><td><label>Nombre de la Comunidad</label></td>
				 ...
				 <?php 
					...
					$dd=$dbb->consulta("select * from especiefauna");
					 
					for ($f=1;$f<=mysql_num_rows($dd);$f++)
					{    $i=mysql_result($dd,$f-1,"idespeciefauna");
				...
				?>	
					...
					<td><input type="text" name="zonageo" value="<?php echo $mod2; ?>" size="15" title='Zona Geograf&iacute;ca'></td>
					<td><input type="text" name="cant" value="<?php echo $mod3; ?>"  size="3" title='Cantidad Posee'></td>
					<td>		      
			...
			if (isset($_POST["codigo"]))
			{
						...
						$mov= new acciones();
						echo $mov->Modificar("recursofauna","idespeciefauna='$a',zona='$c',cantidad='$d',idmedioamb='$e',idcomunidad='$f'","idrecursofauna='$a'");
			}	?>
