...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("nivelacad","idnivelacad,nivel","'$a','$b'");
               }
            }
        ?>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mnivelacad.php';"></td>
		...
		<fieldset>
                ...
                Nivel Academico
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('nivelacad','idnivelacad'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Nivel Academico:</label></td>
				  <td><input type="text" name="nivel" value="" required="required" autofocus title='Nuevo Nivel Academico'></td></tr>		 
							</table> 
						</fieldset>			 
					</form>		
					...
					<?php if ($ms!='') echo " <script>alert('$ms');</script>"; ?>
						...
						<form action="nivelacad.php" method="get">
						<table>
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("nivelacad","nivel","idnivelacad='$ii'");
			}
			...
			echo $con->consultar("nivelacad","idnivelacad as'Codigo',nivel as 'Nivel Academico'","idnivelacad order by idnivelacad desc limit 5");
