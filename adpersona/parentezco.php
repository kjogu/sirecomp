...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("parentezco","idparentezco,parentezco","'$a','$b'");
               }
            }
        ?>
...
<html lang="es">
    <head>
        <title>Parentesco Familiar</title>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mparentezco.php';"></td>
		...
		<fieldset>
                ...
                Parentesco Familiares
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('parentezco','idparentezco'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Parentesco:</label></td>
				  <td><input type="text" name="parentezco" value="" required="required" autofocus title='Nuevo Parentesco'></td></tr>		 
								</table> 
							</fieldset>			 
						</form>		
					...
					<?php if ($ms!='') echo " <script>alert('$ms');</script>"; ?>
						...
						<form action="parentezco.php" method="get">
						<table>
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("parentezco","parentezco","idparentezco='$ii'");
			}
			...
			echo $con->consultar("parentezco","idparentezco as'Codigo',parentezco as 'Parentesco Familiar'","idparentezco order by idparentezco desc limit 5");
