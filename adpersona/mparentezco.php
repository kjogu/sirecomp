...
if (isset($_GET['id']))
	{
		...
		$id=$_GET['id'];
		$b=new consultas();
		$mod1=$b->buscarvalor("parentezco","parentezco","idparentezco='$id'");
 	...
 	if (isset($_GET['idb']))
	{
		...
		$id=$_GET['idb'];
		$b=new acciones();
		$mod1=$b->borrar("parentezco","idparentezco='$id'");
...
<html>
    <head>
        <title>Parentezco Familiar</title>
		...
		<div id="menu">
            <li><a href='../comunidad/comunidad.php'><img border="0" src='../libreria/images/home.png' width="25" height="25" title="Inicio"></a></li>
				...
				<li><a href='../index.php'>Cerrar Sesi&oacute;n</a></li>			
						...
						<form action="mparentezco.php" method="get">
						<table>
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="mparentezco.php" >
			<fieldset>
                <legend>
                Parentesco Familiares
				  ...
				  <td><input type="text" name="parentezco" value="<?php echo $mod1; ?>" required="required" autofocus title='Nuevo Parentesco'></td></tr>		 
		...
		<?php }
			if (isset($_POST["codigo"]))
			{
				...
				$mov=new acciones();
				echo $mov->Modificar("parentezco","parentezco='$b'","idparentezco='$a'");
             	}	?>
