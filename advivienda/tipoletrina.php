...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("tipoletrina","idtipoletrina,tipo","'$a','$b'");
               }
            }
        ?>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mtipoletrina.php';"></td>
		...
		<fieldset>
                ...
                Tipo Letrina
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('tipoletrina','idtipoletrina'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Tipo Letrina:</label></td>
				  <td><input type="text" name="tipo" value="" required="required" autofocus title='Nuevo Tipo'></td></tr>		 
					...
					<?php if ($ms!='') echo " <script>alert('$ms');</script>"; ?>
						...
						<form action="tipoletrina.php" method="get">
						<table>
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("tipoletrina","tipo","idtipoletrina='$ii'");
			}
			...
			echo $con->consultar("tipoletrina","idtipoletrina as'Codigo',tipo as 'Tipo Letrina'","idtipoletrina order by idtipoletrina desc limit 5");
