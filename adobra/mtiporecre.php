...
if (isset($_GET['id']))
	{
		...
		$id=$_GET['id'];
		$b=new consultas();
		$mod1=$b->buscarvalor("tiporecre","tipo","idtiporecre='$id'");
 	...
 	if (isset($_GET['idb']))
	{
		...
		$id=$_GET['idb'];
		$b=new acciones();
		$mod1=$b->borrar("tiporecre","idtiporecre='$id'");
...
<html>
    <head>
        <title>Tipo Recreaci&oacute;n</title>
		...
		<div id="menu">
            <li><a href='../comunidad/comunidad.php'><img border="0" src='../libreria/images/home.png' width="25" height="25" title="Inicio"></a></li>
				...
				<li><a href='../index.php'>Cerrar Sesi&oacute;n</a></li>			
						...
						<form action="mtiporecre.php" method="get">
						<table>
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="mtiporecre.php" >
			<fieldset>
                <legend>
               Tipo de Recreaci&oacute;n
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="tipo" value="<?php echo $mod1; ?>" required="required" autofocus title='Nuevo Tipo'></td></tr>		 
						</table> 
		...
		<?php }
			if (isset($_POST["codigo"]))
			{
				...
				$mov=new acciones();
				echo $mov->Modificar("tiporecre","tipo='$b'","idtiporecre='$a'");
             	}	?>
