...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("condicion","idcondicion,condicion","'$a','$b'");
					}
            }
        ?>
...
<div id="todo">
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mcondicion.php';"></td>
		...
		<fieldset>
			 ...
			 <td><input type="text" name="codigo" id="codigo" value="<?php echo newid("condicion","idcondicion"); ?>" readonly></td></tr>
             
			 <tr><td><label>Condici&oacute;n:</label></td>
			 <td><input type="text" name="cond" value="" placeholder= 'Digete Nueva Condici&oacute;n' title='Digete Nueva Condici&oacute;n' required="required" autofocus></td></tr>
			...
			<?php if ($ms!='') echo " <script>alert('$ms');</script>"; ?>
						...
						<form action="condicion.php" method="get">
						<table>
			...
			{  //para buscar
				$ii=$_GET['bu'];
				$b=new consultas();
				echo $b->buscarvalor("condicion","condicion","idcondicion='$ii'");
			}
			...
			echo $con->consultar("condicion","idcondicion as 'Codigo',condicion as 'Condici&oacute;n'","idcondicion order by idcondicion desc limit 5");
