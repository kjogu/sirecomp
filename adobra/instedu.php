...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("instedu","idinstedu,institucion","'$a','$b'");
               }
            }
        ?>
...
<html lang="es">
    <head>
        <title>Instituci&oacute;n Educativa</title>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='minstedu.php';"></td>
		...
		<fieldset>
                ...
                Instituci&oacute;n Educativa
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('instedu','idinstedu'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Medio Ambiente:</label></td>
				  <td><input type="text" name="nombre" value="" required="required" autofocus title='Digite Instituci&oacute;n Educativa'></td></tr>		 
					 </table> 
					</fieldset>			 
				</form>		
					...
					<?php if ($ms!='') echo " <script>alert('$ms');</script>"; ?>
						...
						<form action="instedu.php" method="get">
						<table>
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("instedu","institucion","idinstedu='$ii'");
			}
			...
			echo $con->consultar("instedu","idinstedu as'Codigo',institucion as 'Instituci&oacute;n Educativa'","idinstedu order by idinstedu desc limit 5");
