...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("obras","idobras,nombre,idcomunidad","'$a','$b','$c'");
               }
            }
        ?>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mobras.php';"></td>
		...
		<fieldset>
                ...
                Obra Social
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('obras','idobras'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Obra Social:</label></td>
				  <td><input type="text" name="nombre" value="" required="required" autofocus title='Nueva Obra Social'></td></tr>		 
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("obras","nombre","idobras='$ii'");
			}
			...
			echo $con->consultar("obras,comunidad","idobras as'Codigo',obras.nombre as 'Nombre Obra Social',comunidad.nombre","comunidad.idcomunidad=obras.idcomunidad order by obras.idobras desc limit 5");
