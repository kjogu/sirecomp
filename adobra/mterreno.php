...
if (isset($_GET['id']))
	{
		...
		$id=$_GET['id'];
		$b=new consultas();
		$mod1=$b->buscarvalor("terreno","tipo","idterreno='$id'");
 	...
 	if (isset($_GET['idb']))
	{
		...
		$id=$_GET['idb'];
		$b=new acciones();
		$mod1=$b->borrar("terreno","idterreno='$id'");
...
<html>
    <head>
        <title>Terreno segun Legalidad</title>
		...
		<div id="menu">
           <li><a href='../comunidad/comunidad.php'><img border="0" src='../libreria/images/home.png' width="25" height="25" title="Inicio"></a></li>
				...
				<li><a href='../index.php'>Cerrar Sesi&oacute;n</a></li>			
						...
						<form action="mterreno.php" method="get">
						<table>
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="mterreno.php" >
			<fieldset>
                <legend>
                Terreno Seg&uacute;n Legalidad
                </legend>
								<table id="tabla">
		...
		<?php }
			if (isset($_POST["codigo"]))
			{
				...
				$mov=new acciones();
				echo $mov->Modificar("terreno","tipo='$b'","idterreno='$a'");
             	}	?>
