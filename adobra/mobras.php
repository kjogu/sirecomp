...
if (isset($_GET['id']))
	{
		...
		$mod2=$b->buscarvalor("obras","idcomunidad","idobras='$id'");		
		...
		<div id="menu">
            <li><a href='../comunidad/comunidad.php'><img border="0" src='../libreria/images/home.png' width="25" height="25" title="Inicio"></a></li>
				...
				<li><a href='../index.php'>Cerrar Sesi&oacute;n</a></li>			
						...
						<form action="mobras.php" method="get">
						<table>
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="mobras.php" >
			<fieldset>
                <legend>
                Obra Social
                </legend>
                 <table id="tabla">
				  ...
				  <td><input type="text" name="nombre" value="<?php echo $mod1; ?>" required="required" autofocus title='Obra Social'></td></tr>		 
				
				  <tr><td><label>Zona:</label></td>
						<td>
						<?php
						$b=new consultas();
						echo $b->modselectdetabla("comunidad","nombre","idcomunidad",$mod2);
						?></td></tr>  
					 </table> 
		...
		<?php }
			if (isset($_POST["codigo"]))
			{
				...
				$mov=new acciones();
				echo $mov->Modificar("obras","nombre='$b',idcomunidad='$c'","idobras='$a'");
             	}	?>
