...
if (isset($_GET['id']))
	{
		...
		$id=$_GET['id'];
		$b=new consultas();
		$mod1=$b->buscarvalor("condicion","condicion","idcondicion='$id'");
 	...
 	if (isset($_GET['idb']))
	{
		...
		$id=$_GET['idb'];
		$b=new acciones();
		$mod1=$b->borrar("condicion","idcondicion='$id'");
		...
		<div id="menu">
           <li><a href='../comunidad/comunidad.php'><img border="0" src='../libreria/images/home.png' width="25" height="25" title="Inicio"></a></li>
				...
				<li><a href='../index.php'>Cerrar Sesi&oacute;n</a></li>			
						...
						<form action="mcondicion.php" method="get">
						<table>
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="mcondicion.php" >
			<fieldset>
                <legend>
                Condici&oacute;n
                </legend>
			 ...
			 <td><input type="text" name="condicion" value="<?php echo $mod1;?>" placeholder= 'Digete Nueva Condici&oacute;n' title='Digete Nueva Condici&oacute;n' required="required" autofocus></td></tr>
		...
		<?php }
			if (isset($_POST["codigo"]))
			{
				...
				$mov=new acciones();
				echo $mov->Modificar("condicion","condicion='$b'","idcondicion='$a'");
             	}	?>
