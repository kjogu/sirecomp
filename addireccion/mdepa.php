...
if (isset($_GET['id']))
	{
		...
		$id=$_GET['id'];
		$b=new consultas();
		$mod1=$b->buscarvalor("depa","departamento","iddepa='$id'");
		...
		<div id="menu">
            <li><a href='../comunidad/comunidad.php'><img border="0" src='../libreria/images/home.png' width="25" height="25" title="Inicio"></a></li>
				...
				<li><a href='../index.php'>Cerrar Sesi&oacute;n</a></li>			
						...
						<form action="mdepa.php" method="get">
						<table>
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="mdepa.php" >
			<fieldset>
                <legend>
                Departamento
                </legend>
                 <table id="tabla">
				  ...
				  <td><input type="text" name="depa" value="<?php echo $mod1; ?>" required="required" autofocus title='Nuevo Departamento'></td></tr>		 
					 </table>
		...
		<?php }
			if (isset($_POST["codigo"]))
			{
				...
				$mov=new acciones();
				echo $mov->Modificar("depa","departamento='$b'","iddepa='$a'");
             	}	?>
