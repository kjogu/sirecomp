...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("sector","idsector,nombre,idzona","'$a','$b','$c'");
               }
            }
        ?>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='msector.php';"></td>
		...
		<fieldset>
                ...
                Sector
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('sector','idsector'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Nombre Sector:</label></td>
				  <td><input type="text" name="sector" value="" required="required" autofocus title='Digite Nuevo Sector'></td></tr>		 
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("sector","nombre","idsector='$ii'");
			}
			...
			echo $con->consultar("sector,zona","idsector as'Codigo',sector.nombre as 'Nombre Sector',zona.nombre as 'Nombre Zona'","zona.idzona=sector.idzona order by sector.idsector desc limit 5");
