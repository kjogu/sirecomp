...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("municipio","idmunicipio,nombre,iddepa","'$a','$b','$c'");
               }
            }
        ?>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mmunicipio.php';"></td>
		...
		<fieldset>
                ...
                Municipio
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('municipio','idmunicipio'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Municipio:</label></td>
				  <td><input type="text" name="nombre" value="" required="required" autofocus title='Nuevo Municipio'></td></tr>		 
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("municipio","nombre","idmunicipio='$ii'");
			}
			...
			echo $con->consultar("municipio,depa","idmunicipio as'Codigo',nombre as 'Municipio',depa.departamento as 'Departamento'","depa.iddepa=municipio.iddepa order by municipio.idmunicipio desc limit 5");
