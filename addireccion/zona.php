...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("zona","idzona,nombre","'$a','$b'");
               }
            }
        ?>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mzona.php';"></td>
		...
		<fieldset>
                ...
                Zona
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('zona','idzona'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Nombre Zona:</label></td>
				  <td><input type="text" name="nombre" value="" required="required" autofocus title='Nueva Zona'></td></tr>		 
					...
					<?php if ($ms!='') echo " <script>alert('$ms');</script>"; ?>
						...
						<form action="zona.php" method="get">
						<table>
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("zona","nombre,codigo","idzona='$ii'");
			}
			...
			echo $con->consultar("zona","idzona as'Codigo',nombre as 'Nombre Zona'","idzona order by idzona desc limit 5");
