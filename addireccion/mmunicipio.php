...
if (isset($_GET['id']))
	{
		...
		$id=$_GET['id'];
		$b=new consultas();
		$mod1=$b->buscarvalor("municipio","nombre","idmunicipio='$id'");
		$mod2=$b->buscarvalor("municipio","iddepa","idmunicipio='$id'");		
 	...
 	if (isset($_GET['idb']))
	{
		...
		$id=$_GET['idb'];
		$b=new acciones();
		$mod1=$b->borrar("municipio","idmunicipio='$id'");
		...
		<div id="menu">
             <li><a href='../comunidad/comunidad.php'><img border="0" src='../libreria/images/home.png' width="25" height="25" title="Inicio"></a></li>
				...
				<li><a href='../index.php'>Cerrar Sesi&oacute;n</a></li>			
						...
						<form action="mmunicipio.php" method="get">
						<table>
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="mmunicipio.php" >
			<fieldset>
                <legend>
                Municipio
                </legend>
                 <table id="tabla">
				  ...
				  <td><input type="text" name="nombre" value="<?php echo $mod1; ?>" required="required" autofocus title='Nuevo Municipio'></td></tr>		 
				
				  <tr><td><label>Departamento:</label></td>
					<td>
					<?php
					$b=new consultas();
					echo $b->modselectdetabla("depa","departamento","iddepa",$mod2);
					?></td></tr>  
		...
		<?php }
			if (isset($_POST["codigo"]))
			{
				...
				$mov=new acciones();
				echo $mov->Modificar("municipio","nombre='$b',iddepa='$c'","idmunicipio='$a'");
             	}	?>
