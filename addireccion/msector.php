...
if (isset($_GET['id']))
	{
		...
		$id=$_GET['id'];
		$b=new consultas();
		$mod1=$b->buscarvalor("sector","nombre","idsector='$id'");
		$mod2=$b->buscarvalor("sector","idzona","idsector='$id'");
 	...
 	if (isset($_GET['idb']))
	{
		...
		$id=$_GET['idb'];
		$b=new acciones();
		$mod1=$b->borrar("sector","idsector='$id'");
		...
		<div id="menu">
            <li><a href='../comunidad/comunidad.php'><img border="0" src='../libreria/images/home.png' width="25" height="25" title="Inicio"></a></li>
				...
				<li><a href='../index.php'>Cerrar Sesi&oacute;n</a></li>			
						...
						<form action="msector.php" method="get">
						<table>
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="msector.php" >
			<fieldset>
                <legend>
                Sector
                </legend>
				  ...
				  <td><input type="text" name="sector" value="<?php echo $mod1; ?>" required="required" autofocus title='Nuevo Sector'></td></tr>		 
				
				  <tr><td><label>Zona:</label></td>
				  <td>
					<?php
					$b=new consultas();
					echo $b->modselectdetabla("zona","nombre","idzona",$mod2);
					?></td></tr>  
		...
		<?php }
			if (isset($_POST["codigo"]))
			{
				...
				$mov=new acciones();
				echo $mov->Modificar("sector","nombre='$b',idzona='$c'","idsector='$a'");
             	}	?>
