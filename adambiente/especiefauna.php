...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("especiefauna","idespeciefauna,nombre","'$a','$b'");
               }
            }
        ?>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mfauna.php';"></td>
		...
		<fieldset>
                ...
                Especie Fauna
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('especiefauna','idespeciefauna'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Especie:</label></td>
				  <td><input type="text" name="nombre" value="" required="required" autofocus title='Eliga Medio Ambiente'></td></tr>		 
					 </table> 
					</fieldset>			 
				</form>		
					...
					<?php if ($ms!='') echo " <script>alert('$ms');</script>"; ?>
						...
						<form action="especiefauna.php" method="get">
						<table>
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("especiefauna","nombre","idespeciefauna='$ii'");
			}
			...
			echo $con->consultar("especiefauna","idespeciefauna as'Codigo',nombre as 'Especie Fauna'","idespeciefauna order by idespeciefauna desc limit 5");
