...
if (isset($_GET['id']))
	{
		...
		$id=$_GET['id'];
		$b=new consultas();
		$mod1=$b->buscarvalor("especieflora","nombre","idespecieflora='$id'");
 	...
 	if (isset($_GET['idb']))
	{
		...
		$id=$_GET['idb'];
		$b=new acciones();
		$mod1=$b->borrar("especieflora","idespecieflora='$id'");
		...
		<div id="menu">
            <li><a href='../comunidad/comunidad.php'><img border="0" src='../libreria/images/home.png' width="25" height="25" title="Inicio"></a></li>
				...
				<li><a href='../index.php'>Cerrar Sesi&oacute;n</a></li>			
						...
						<form action="mflora.php" method="get">
						<table>
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="mflora.php" >
			<fieldset>
                <legend>
                Especie Flora
                </legend>
                 <table id="tabla">
				  ...
				  <td><input type="text" name="nombre" value="<?php echo $mod1; ?>" required="required" autofocus title='Nueva Especie'></td></tr>		 
					 </table> 
		...
		<?php }
			if (isset($_POST["codigo"]))
			{
				...
				$mov=new acciones();
				echo $mov->Modificar("especieflora","nombre='$b'","idespecieflora='$a'");
             	}	?>
