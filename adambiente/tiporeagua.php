...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("tiporeagua","idtiporeagua,recurso","'$a','$b'");
               }
            }
        ?>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mtiporeagua.php';"></td>
		...
		<fieldset>
                ...
                Tipo Recurso Agua
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('tiporeagua','idtiporeagua'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Recurso Agua:</label></td>
				  <td><input type="text" name="tipo" value="" required="required" autofocus title='Nuevo Tipo'></td></tr>		 
					...
					<?php if ($ms!='') echo " <script>alert('$ms');</script>"; ?>
						...
						<form action="tiporeagua.php" method="get">
						<table>
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("tiporeagua","recurso","idtiporeagua='$ii'");
			}
			...
			echo $con->consultar("tiporeagua","idtiporeagua as'Codigo',recurso as 'Recurso Agua'","idtiporeagua order by idtiporeagua desc limit 5");
