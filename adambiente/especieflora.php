...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("especieflora","idespecieflora,nombre","'$a','$b'");
               }
            }
        ?>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mflora.php';"></td>
		...
		<fieldset>
                ...
                Especie Flora
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('especieflora','idespecieflora'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Especie Flora:</label></td>
				  <td><input type="text" name="nombre" value="" required="required" autofocus title='Nueva Especie'></td></tr>		 
					 </table> 
					</fieldset>			 
				</form>		
					...
					<?php if ($ms!='') echo " <script>alert('$ms');</script>"; ?>
						...
						<form action="especieflora.php" method="get">
						<table>
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("especieflora","nombre","idespecieflora='$ii'");
			}
			...
			echo $con->consultar("especieflora","idespecieflora as'Codigo',nombre as 'Especie Flora'","idespecieflora order by idespecieflora desc limit 5");
