...
<?php
        ...
        if ($_POST["nuevo"]=="guardar")
				...
				$mov=new acciones();
				$ms= $mov->guardar("medioamb","idmedioamb,ambiente","'$a','$b'");
               }
            }
        ?>
...
<div id='todo'>
	...
	<section>
		...
		<nav id="menu2">
                    <table id="otromenu">
			<td><input type=image src="../libreria/images/forms.png" id="nuevo" name="nuevo" value="modificar" title="Modificar" onclick="location.href='mmedioamb.php';"></td>
		...
		<fieldset>
                ...
                Medio Ambiente
                 ...
                 <table id="tabla">
				  ...
				  <td><input type="text" name="codigo" id="codigo" value="<?php echo newid('medioamb','idmedioamb'); ?>" readonly></td></tr>
                  
				  <tr><td><label>Medio Ambiente:</label></td>
				  <td><input type="text" name="ambiente" value="" required="required" autofocus title='Eliga Medio Ambiente'></td></tr>		 
					 </table> 
					</fieldset>			 
				</form>		
					...
					<?php if ($ms!='') echo " <script>alert('$ms');</script>"; ?>
						...
						<form action="medioamb.php" method="get">
						<table>
			...
			{  //para buscar
				...
				$b=new consultas();
				echo $b->buscarvalor("medioamb","ambiente","idmedioamb='$ii'");
			}
			...
			echo $con->consultar("medioamb","idmedioamb as'Codigo',ambiente as 'M. Ambiente'","idmedioamb order by idmedioamb desc limit 5");
