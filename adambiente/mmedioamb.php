...
if (isset($_GET['id']))
	{
		...
		$id=$_GET['id'];
		$b=new consultas();
		$mod1=$b->buscarvalor("medioamb","ambiente","idmedioamb='$id'");
 	...
 	if (isset($_GET['idb']))
	{
		...
		$id=$_GET['idb'];
		$b=new acciones();
		$mod1=$b->borrar("medioamb","idmedioamb='$id'");
		...
		<div id="menu">
           <li><a href='../comunidad/comunidad.php'><img border="0" src='../libreria/images/home.png' width="25" height="25" title="Inicio"></a></li>
				...
				<li><a href='../index.php'>Cerrar Sesi&oacute;n</a></li>			
						...
						<form action="mmedioamb.php" method="get">
						<table>
...
?>	
        <div id='infoprin'>  
		<form class="comunidad" method="POST" action="mmedioamb.php" >
			<fieldset>
                <legend>
			  ...
			  <table id="tabla">
				  ...
				  <td><input type="text" name="ambiente" value="<?php echo $mod1; ?>" required="required" autofocus title='Eliga Medio Ambiente'></td></tr>		 
					 </table> 
		...
		<?php }
			if (isset($_POST["codigo"]))
			{
				...
				$mov=new acciones();
				echo $mov->Modificar("medioamb","ambiente='$b'","idmedioamb='$a'");
             	}	?>
